...
test('Product Checkout', async ({ page }) => {
    ...
    await page.locator('input[name="proceedToRetailCheckout"][data-feature-id="proceed-to-checkout-action"].a-button-input[type="submit"][value="Proceed to checkout"][aria-labelledby="sc-buy-box-ptc-button-announce"]')
  .click({ timeout: 60000 }); // 60 seconds
    await page.close();
